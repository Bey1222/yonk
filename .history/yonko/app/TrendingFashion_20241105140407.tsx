...
const TrendingFashion = () => {
  ...
  const { trendingFashion } = route.params;
  ...
  const handleNavigation = (item) => {
    ...
    const store = trendingFashion.find((store) => store.id === shopId);
    ...
    console.log("Trending Fashion item:", store);
    ...
    navigation.navigate("MainstoreWardrobe", {
      wardrobe,
