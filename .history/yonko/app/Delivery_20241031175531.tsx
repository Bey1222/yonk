...
const Delivery: React.FC = () => {
  ...
  const [addresses, setAddresses] = useState<string[]>([userData.address]);
  const [activeAddress, setActiveAddress] = useState<string>(userData.address);
  ...
  const handleOptionPress = (option: string) => {
    ...
    if (option === "Pickup") {
      ...
      setActiveAddress(userData.address);
    }
  };
            ...
            >
              <View style={styles.newAddressInputWrapper}>
                <TextInput
                  ...
                  placeholder={`No 1 Shanks Street, ${userData.state}`}
