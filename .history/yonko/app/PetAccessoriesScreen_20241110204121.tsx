...
const PetAccessoriesScreen: React.FC = () => {
    ...
    const fetchDiscountItems = async () => {
      try {
        const response = await fetch(
          `${process.env.EXPO_PUBLIC_BASE_URL}/products?category=PET_ACCESSORIES`,
          {
            headers: {
  ...
  const handleNavigationPetAccessoriesProducts = (
    item: DiscountItem,
    screenName: string
  ) => {
  ...
  const renderItem = ({
    ...
    <TouchableOpacity
      style={styles.card}
      onPress={() =>
        handleNavigationPetAccessoriesProducts(item, "PetSuppliesProducts")
      }
    >
