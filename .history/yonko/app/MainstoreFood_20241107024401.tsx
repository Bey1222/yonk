...
const MainstoreFood: React.FC<{
  ...
  const { shop, products } = restaurant;
  console.log("Received shop data:", shop); // Log the shop object
  console.log("Received products data:", products); // Log the products array
  ...
  console.log("Product details:", {
    ...
    variants: JSON.stringify(item.variants, null, 2), // Pretty-print the variants object
    addOns: item.addOns,
  ...
  useEffect(() => {
    // Use the passed products instead of fetching from an endpoint
    setFilteredProducts(products || []);
  }, [products]);

  const handleMenuItemPress = (item) => {
    console.log("Navigating with item:", item); // Log the item before navigating
    navigation.navigate("FoodProducts", {
      item,
      restaurantName: shop.name,
      restaurantImageUri: shop.avatar,
      restaurantLocation: `${shop.address.street}, ${shop.address.city}, ${shop.address.state}, ${shop.address.country}`,
    });
  };
