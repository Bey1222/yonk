...
const WardrobeProducts = ({ route }) => {
  ...
  console.log("Received wardrobeName:", wardrobeName);
  console.log("Received wardrobeImageUri:", wardrobeImageUri);
  console.log("Received wardrobeLocation:", wardrobeLocation);
  ...
  if (!item || !wardrobeName || !wardrobeImageUri || !wardrobeLocation) {
    console.error("Missing required parameters in WardrobeProducts component");
    return (
  ...
  const handleAddToBasket = () => {
    if (selectedSizes.length === 0) {
      ...
      const basketItem = {
        ...
        sizes: selectedSizes,
        note,
        restaurant: wardrobeName, // Add the wardrobe name
        restaurantImageUri: wardrobeImageUri, // Use the passed wardrobeImageUri
        restaurantLocation: wardrobeLocation, // Add the wardrobe location
  ...
  const handleFavoritePress = () => {
    ...
    addToWishlist({
      ...
      image: item.images[0],
      sizes: selectedSizes,
      restaurantName: wardrobeName, // Add the wardrobe name
      restaurantImageUri: wardrobeImageUri, // Add the wardrobe image URI
      restaurantLocation: wardrobeLocation, // Add the wardrobe location
    });
