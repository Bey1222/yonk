...
const SupernarketProducts = ({ route }) => {
  ...
  // Parse the variants string into an object if it's a string
  const variants =
  ...
  const renderVariants = () => {
      ...
      return variants.map((variant, index) => (
        <View key={index} style={styles.variantContainer}>
          ...
          {variant.variantValues && variant.variantValues.length > 0 ? (
            variant.variantValues.map((variantValue, vIndex) => (
    ...
    } else if (variants.variantValues) {
      return (
        <View style={styles.variantContainer}>
          ...
          {variants.variantValues.length > 0 ? (
            variants.variantValues.map((variantValue, vIndex) => (
              <View key={vIndex} style={styles.variantValueContainer}>
                <Text style={[styles.variantValue, { color: "#fff" }]}>
                  {variantValue.value}
                </Text>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.detailsContainer}>
          ...
          <View style={styles.sizesContainer}>
            {variants && (Array.isArray(variants) || variants.variantValues) ? (
