...
interface NewarrivalsSupermarketProps {
  newItems: NewArrivalItem[];
}

const NewarrivalsSupermarket: React.FC = () => {
  const route = useRoute();
  const navigation = useNavigation();
  const { colors } = useTheme();
  const { newItems } = route.params as NewarrivalsSupermarketProps;
