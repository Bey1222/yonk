...
const PharmacyProducts = ({ route }) => {
  ...
  const renderVariants = () => {
    if (!variants || (Array.isArray(variants) && variants.length === 0) || (typeof variants === 'object' && variants.variantValues && variants.variantValues.length === 0)) {
      return (
                      ...
                      <TouchableOpacity
                        ...
                        onPress={() =>
                          handleSizePress({
                            ...
                            price:
                              variantValue.options?.[0]?.optionValues?.[0]
                                ?.price || 0, // Access the nested price
                          })
                        }
                      >
                        <Text
