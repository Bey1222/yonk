...
interface NewarrivalsPharmacyProps {
  newItems: NewItem[];
}

const NewarrivalsPharmacy: React.FC = () => {
  const route = useRoute();
  const navigation = useNavigation();
  const { colors } = useTheme();
  const { newItems } = route.params as NewarrivalsPharmacyProps;
    ...
    <TouchableOpacity
      ...
      onPress={() =>
        navigation.navigate("PharmacyProducts", {
          ...
          pharmacyImageUri: item.pharmacyImageUri,
...
export default NewarrivalsPharmacy;
