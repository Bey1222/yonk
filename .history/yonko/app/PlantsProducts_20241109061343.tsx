...
const PlantsProducts = ({ route }) => {
  ...
  console.log("Received plantImageUri:", plantImageUri);
  console.log("Received plantLocation:", plantLocation);
  ...
  if (!item || !plantName || !plantImageUri || !plantLocation) {
    console.error("Missing required parameters in PlantsProducts component");
    return (
  ...
  const handleAddToBasket = async () => {
    if (selectedSizes.length === 0) {
      ...
      const basketItem = {
        ...
        restaurantImageUri: plantImageUri, // Use the passed plant image URI
  ...
  return (
    <LinearGradient
      colors={["#737373", "rgba(34, 139, 34, .7)", "#737373"]}
      locations={[1, 0.2, 1]}
      start={{ x: 0.5, y: 0 }}
      end={{ x: 0, y: 0.7 }}
