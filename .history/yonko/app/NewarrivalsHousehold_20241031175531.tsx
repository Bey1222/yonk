...
interface NewarrivalsHouseholdProps {
  newItems: NewItem[];
}

const NewarrivalsHousehold: React.FC = () => {
  const route = useRoute();
  const navigation = useNavigation();
  const { colors } = useTheme();
  const { newItems } = route.params as NewarrivalsHouseholdProps;
    ...
    <TouchableOpacity
      ...
      onPress={() =>
        navigation.navigate("HouseholdProducts", {
          item,
          householdName: item.parentObj.name,
          householdImageUri: item.parentObj.image,
          householdLocation: item.parentObj.location,
        })
      }
    >
