                ...
                <TouchableOpacity
                  ...
                  onPress={() =>
                    handleSizePress({
                      ...
                      price: variantValue.options.optionValues[0]?.price || 0, // Access the price from the first optionValue
                    })
                  }
                >
                  <Text
                  ...
                  >
                    {variantValue.value} (₦
                    {variantValue.options.optionValues[0]?.price
                      ? variantValue.options.optionValues[0]?.price.toFixed(2)
                      : "0.00"}
                    )
                  </Text>
                </TouchableOpacity>
