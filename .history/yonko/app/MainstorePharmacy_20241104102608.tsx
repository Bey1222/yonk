...
const MainstorePharmacy: React.FC<{
  ...
  const handleMenuItemPress = (item: any) => {
    navigation.navigate("PharmacyProducts", {
      ...
      pharmacyImageUri: pharmacy.shop.image,
      pharmacyLocation: `${pharmacy.shop.address.street}, ${pharmacy.shop.address.city}, ${pharmacy.shop.address.state}, ${pharmacy.shop.address.country}`, // Include the location here
    });
  };
  ...
  const shortDescription = pharmacy.shop.about
    ? pharmacy.shop.about.split(" ").slice(0, 30).join(" ") + "..."
    ...
    <TouchableWithoutFeedback onPress={handleDismissKeyboard}>
      ...
      >
        <View style={styles.container}>
          <Animated.Image
            source={{ uri: pharmacy.shop.image }}
