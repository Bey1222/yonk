...
const SucculentsScreen: React.FC = () => {
    ...
    const fetchDiscountItems = async () => {
      try {
        const response = await fetch(
          `${process.env.EXPO_PUBLIC_BASE_URL}/products?category=SUCCULENTS`,
          {
            headers: {
  ...
  const handleNavigationPlantsProducts = (
    item: DiscountItem,
    screenName: string
  ) => {
    ...
    if (screenName === "PlantsProducts") {
      navigation.navigate(screenName, {
        ...
        plantLocation: `${store.address.street}, ${store.address.city}, ${store.address.state}, ${store.address.country}`, // Include the location here
      });
    }
  };
  ...
  const renderItem = ({
    ...
    <TouchableOpacity
      style={styles.card}
      onPress={() => handleNavigationPlantsProducts(item, "PlantsProducts")}
    >
...
export default SucculentsScreen;
