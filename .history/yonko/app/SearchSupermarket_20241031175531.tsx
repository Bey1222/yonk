...
import SupermarketData from "../assets/data/grocerydata.json";
...
const SearchSupermarket = () => {
  ...
  const filteredSupermarkets = useMemo(() => {
    let filtered = SupermarketData.groceries;
  ...
  const isRestaurantOpen = (supermarket) => {
  ...
  const handleRestaurantPress = (supermarket) => {
    if (isRestaurantOpen(supermarket)) {
