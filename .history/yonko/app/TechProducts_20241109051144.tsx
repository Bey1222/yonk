...
const TechProducts = ({ route }) => {
  ...
  console.log("Received techName:", techName);
  console.log("Received techImageUri:", techImageUri);
  console.log("Received techLocation:", techLocation);
  ...
  if (!item || !techName || !techImageUri || !techLocation) {
    console.error("Missing required parameters in TechProducts component");
    return (
  ...
  const handleAddToBasket = async () => {
    if (selectedSizes.length === 0) {
      ...
      const basketItem = {
        ...
        sizes: selectedSizes,
        note,
        restaurant: techName, // Add the tech name
        restaurantImageUri: techImageUri, // Use the passed techImageUri
        restaurantLocation: techLocation, // Add the tech location
  ...
  const handleFavoritePress = () => {
    ...
    addToWishlist({
      ...
      image: item.images[0],
      sizes: selectedSizes,
      restaurantName: techName, // Add the tech name
      restaurantImageUri: techImageUri, // Add the tech image URI
      restaurantLocation: techLocation, // Add the tech location
    });
        ...
        <View style={styles.detailsContainer}>
          ...
          <ScrollView horizontal showsHorizontalScrollIndicator={false}>
            <View style={styles.sizesContainer}>
              {variants &&
              (Array.isArray(variants) || variants.variantValues) ? (
