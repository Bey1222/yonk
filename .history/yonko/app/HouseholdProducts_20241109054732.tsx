...
const HouseholdProducts = ({ route }) => {
  ...
  console.log("Received householdName:", householdName);
  console.log("Received householdImageUri:", householdImageUri);
  console.log("Received householdLocation:", householdLocation);
  ...
  if (!item || !householdName || !householdImageUri || !householdLocation) {
    console.error("Missing required parameters in HouseholdProducts component");
    return (
  ...
  const handleAddToBasket = () => {
    if (selectedSizes.length === 0) {
      ...
      const basketItem = {
        ...
        sizes: selectedSizes,
        note,
        restaurant: householdName, // Add the household name
        restaurantImageUri: householdImageUri, // Use the passed householdImageUri
        restaurantLocation: householdLocation, // Add the household location
  ...
  const handleFavoritePress = () => {
    ...
    addToWishlist({
      ...
      image: item.images[0],
      sizes: selectedSizes,
      restaurantName: householdName, // Add the household name
      restaurantImageUri: householdImageUri, // Add the household image URI
      restaurantLocation: householdLocation, // Add the household location
    });
  ...
  return (
    <LinearGradient
      colors={["#737373", "rgba(175, 238, 238, .8)", "#737373"]}
      locations={[1, 0.2, 1]}
      start={{ x: 0.5, y: 0 }}
      end={{ x: 0, y: 0.7 }}
