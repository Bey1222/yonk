...
const MainstoreWardrobe: React.FC<{
  ...
  const [filteredMenu, setFilteredMenu] = useState(wardrobe.menu);
  ...
  const handleMenuItemPress = (item: any) => {
    navigation.navigate("WardrobeProducts", {
      ...
      wardrobeImageUri: wardrobe.image,
      wardrobeLocation: wardrobe.location, // Include the location here
    });
  };
  ...
  const shortDescription = wardrobe.about
    ? wardrobe.about.split(" ").slice(0, 30).join(" ") + "..."
    : "No description available.";

  const handleSearchChange = (text: string) => {
    setSearchKeyword(text);
    const filtered = wardrobe.menu.filter((item) =>
  ...
  useEffect(() => {
    ...
    console.log("Menu:", wardrobe.menu);
  }, [route.params]);

  if (!wardrobe || !wardrobe.menu) {
    return (
      ...
      >
        <View style={styles.container}>
          ...
          <View style={styles.deliveryTimeContainer}>
            ...
            <Text style={styles.deliveryTime}>{wardrobe.deliveryTime}</Text>
          </View>

          <View style={styles.ratingContainer}>
            <Image source={starIcon} style={styles.starIcon} />
            <Text style={styles.ratingText}>{wardrobe.rating}</Text>
          </View>
          <View style={styles.locationContainer}>
            <Image source={locationIcon} style={styles.locationIcon} />
            <Text style={styles.location}>{wardrobe.location}</Text>
          </View>
          ...
          >
            ...
            >
              <View style={styles.nameContainer}>
                <Text style={styles.name}>{wardrobe.name}</Text>
                <TouchableOpacity>
                  <Image
                ...
                <View style={styles.aboutCard}>
                  <View style={styles.aboutCardContent}>
                    <Text style={styles.about}>
                      {showFullDescription ? wardrobe.about : shortDescription}
                    </Text>
                    <TouchableOpacity
                      onPress={() =>
