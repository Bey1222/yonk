...
const MainstoreFood: React.FC<{
  ...
  console.log(restaurant); // Log the restaurant object
  ...
  const handleMenuItemPress = (item: any) => {
    navigation.navigate("FoodProducts", {
      ...
      restaurantImageUri: restaurant.image,
      restaurantLocation: restaurant.location, // Include the location here
    });
  };
  ...
  const shortDescription = restaurant.about
    ? restaurant.about.split(" ").slice(0, 30).join(" ") + "..."
