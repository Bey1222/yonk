...
const PetSuppliesProducts = ({ route }) => {
  const {
    item = {},
    petSupplyName = "",
    petSupplyImageUri = "",
  ...
  console.log("Received petSupplyName:", petSupplyName);
  console.log("Received petSupplyImageUri:", petSupplyImageUri);
  console.log("Received petSupplyLocation:", petSupplyLocation);
  ...
  if (!item || !petSupplyName || !petSupplyImageUri || !petSupplyLocation) {
    console.error(
      "Missing required parameters in PetSuppliesProducts component"
    );
    return (
  ...
  const handleAddToBasket = async () => {
    if (selectedSizes.length === 0) {
      ...
      const basketItem = {
        ...
        sizes: selectedSizes,
        note,
        restaurant: petSupplyName, // Add the pet supply name
        restaurantImageUri: petSupplyImageUri, // Use the passed pet supply image URI
        restaurantLocation: petSupplyLocation, // Add the pet supply location
  ...
  const handleFavoritePress = () => {
    ...
    addToWishlist({
      ...
      image: item.images[0],
      sizes: selectedSizes,
      restaurantName: petSupplyName, // Add the pet supply name
      restaurantImageUri: petSupplyImageUri, // Add the pet supply image URI
      restaurantLocation: petSupplyLocation, // Add the pet supply location
    });
...
export default PetSuppliesProducts;
