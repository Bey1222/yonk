...
const SmartphonesScreen: React.FC = () => {
    ...
    const fetchDiscountItems = async () => {
      try {
        const response = await fetch(
          `${process.env.EXPO_PUBLIC_BASE_URL}/products?category=import React, { useState, useEffect } from "react";
          import {
            View,
            Text,
            FlatList,
          ...
          const GamingScreen: React.FC = () => {
            ...
            useEffect(() => {
              const fetchDiscountItems = async () => {
                try {
                  const response = await fetch(
                    `${process.env.EXPO_PUBLIC_BASE_URL}/products?category=GAMING`,
                    {
                      headers: {
            ...
            const handleNavigationTechProducts = (
              item: DiscountItem,
              screenName: string
            ) => {
