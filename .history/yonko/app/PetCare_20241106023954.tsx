...
const PetCare: React.FC = () => {
  ...
  const { petCare } = route.params as PetCareProps;
  ...
  const handleNavigation = (item) => {
    ...
    const store = petCare.find((store) => store.id === shopId);
    ...
    console.log("Top Pet Supplies item:", store);
  ...
  const renderItem = ({ item }: { item: PetCareItem }) => (
    <TouchableOpacity
      style={styles.card}
