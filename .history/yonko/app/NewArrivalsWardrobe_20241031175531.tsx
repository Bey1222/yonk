...
interface NewarrivalsWardrobeProps {
  newItems: NewItem[];
}

const NewArrivalsWardrobe: React.FC = () => {
  const route = useRoute();
  const navigation = useNavigation();
  const { colors } = useTheme();
  const { newItems } = route.params as NewarrivalsWardrobeProps;
    ...
    <TouchableOpacity
      ...
      onPress={() =>
        navigation.navigate("WardrobeProducts", {
          item,
          wardrobeName: item.parentObj.name,
          wardrobeImageUri: item.parentObj.image,
          wardrobeLocation: item.parentObj.location,
        })
      }
    >
