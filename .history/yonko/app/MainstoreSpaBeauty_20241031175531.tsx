...
const MainstoreSpaBeauty: React.FC<{
  ...
  console.log(spa); // Log the spa object
  const navigation = useNavigation();
  const [showFullDescription, setShowFullDescription] = useState(false);
  const [searchKeyword, setSearchKeyword] = useState("");
  const [filteredMenu, setFilteredMenu] = useState(spa.menu);
  ...
  const handleMenuItemPress = (item: any) => {
    navigation.navigate("SpaBeautyProducts", {
      item,
      spaName: spa.name,
      spaImageUri: spa.image,
      spaLocation: spa.location, // Include the location here
    });
  };
  ...
  const shortDescription = spa.about
    ? spa.about.split(" ").slice(0, 30).join(" ") + "..."
    : "No description available.";

  const handleSearchChange = (text: string) => {
    setSearchKeyword(text);
    const filtered = spa.menu.filter((item) =>
      ...
      >
        <View style={styles.container}>
          ...
          <View style={styles.deliveryTimeContainer}>
            ...
            <Text style={styles.deliveryTime}>{spa.deliveryTime}</Text>
          </View>
          ...
          <View style={styles.locationContainer}>
            ...
            <Text style={styles.location}>{spa.location}</Text>
          </View>
          ...
          >
            ...
            >
              <View style={styles.nameContainer}>
                <Text style={styles.name}>{spa.name}</Text>
                <TouchableOpacity>
                  <Image
                ...
                <View style={styles.aboutCard}>
                  <View style={styles.aboutCardContent}>
                    <Text style={styles.about}>
                      {showFullDescription ? spa.about : shortDescription}
                    </Text>
                    <TouchableOpacity
                      onPress={() =>
