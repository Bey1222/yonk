...
const SpaBeautyProducts = ({ route }) => {
  ...
  console.log("Received spaName:", spaName);
  console.log("Received spaImageUri:", spaImageUri);
  console.log("Received spaLocation:", spaLocation);
  ...
  if (!item || !spaName || !spaImageUri || !spaLocation) {
    console.error("Missing required parameters in SpaBeautyProducts component");
    return (
  ...
  const handleAddToBasket = () => {
    if (selectedSizes.length === 0) {
      ...
      const basketItem = {
        ...
        sizes: selectedSizes,
        note,
        restaurant: spaName, // Add the spa name
        restaurantImageUri: spaImageUri, // Use the passed spaImageUri
        restaurantLocation: spaLocation, // Add the spa location
  ...
  const handleFavoritePress = () => {
    ...
    addToWishlist({
      ...
      image: item.images[0],
      sizes: selectedSizes,
      restaurantName: spaName, // Add the spa name
      restaurantImageUri: spaImageUri, // Add the spa image URI
      restaurantLocation: spaLocation, // Add the spa location
    });
...
export default SpaBeautyProducts;
