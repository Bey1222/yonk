        ...
        >
          ...
          >
            ...
            {renderInput(
              ...
              "birthDate",
              (text) =>
                setUserData((prevData) => ({ ...prevData, birthDate: text })),
              "Date of Birth"
            )}
            {renderInput(
            ...
            {renderInput(
              ...
              (text) =>
                setUserData((prevData) => ({
                  ...prevData,
                  address: { ...prevData.address, street: text },
                })),
              "Street"
            )}
            {renderInput(
              ...
              (text) =>
                setUserData((prevData) => ({
                  ...prevData,
                  address: { ...prevData.address, city: text },
                })),
              "City"
            )}
            {renderInput(
              ...
              (text) =>
                setUserData((prevData) => ({
                  ...prevData,
                  address: { ...prevData.address, state: text },
                })),
              "State"
            )}
            {renderInput(
              ...
              (text) =>
                setUserData((prevData) => ({
                  ...prevData,
                  address: { ...prevData.address, country: text },
                })),
              "Country"
            )}
          </ScrollView>
