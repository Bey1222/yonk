...
const Supermarket = () => {
  ...
  const navigateToBrandScreen = (brand) => {
    if (brand === "Fresh Produce") {
      navigation.navigate("FreshProduceScreen");
    } else if (brand === "Dairy & Eggs") {
      navigation.navigate("DairyEggsScreen");
    } else if (brand === "Meat & Seafood") {
      navigation.navigate("MeatSeafoodScreen");
  ...
  const handleNavigation = (item, screenName) => {
    ...
    navigation.navigate(screenName, {
      ...
      supermarketImageUri: store.avatar,
      supermarketLocation: `${store.address.street}, ${store.address.city}, ${store.address.state}, ${store.address.country}`,
    });
  };

  const handleNavigationSupermarketProducts = (item, screenName) => {
    ...
    if (screenName === "SupernarketProducts") {
                  ...
                  onPress={() => {
                    if (section === "Best Groceries") {
                      navigation.navigate("BestGroceries", {
                        bestGroceries: Object.values(storeData),
                      });
                    } else if (section === "Discounts") {
                ...
                {sortItems(sectionData[section]).map((item, idx) => {
                  ...
                  return (
                    <TouchableOpacity
                      ...
                      style={styles.card}
                      onPress={() =>
                        handleNavigationSupermarketProducts(
                          item,
                          "SupernarketProducts"
                        )
                      }
                ...
                {sortItems(sectionData[section]).map((store, idx) => {
                  ...
                  return (
                    <TouchableOpacity
                      ...
                      style={styles.sectionItem}
                      onPress={() =>
                        handleNavigation(store, "MainstoreSupermarket")
                      }
                    >
                      <View style={styles.imageContainer}>
                        <Image
