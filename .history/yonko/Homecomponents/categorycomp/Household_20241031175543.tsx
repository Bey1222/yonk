...
import householdData from "../../assets/data/householddata.json";
...
const Household = () => {
  ...
  const [categoryData, setCategoryData] = useState(householdData.household);
  ...
  const handleItemPress = (item, section) => {
    if (section === "Essential Items") {
      ...
      navigation.navigate("HouseholdProducts", {
        ...
        householdImageUri: item.householdImageUri,
        householdLocation: item.householdLocation,
      });
    }
  };
  ...
  const handleSectionPress = (section) => {
    if (section === "Essential Items") {
      ...
      navigation.navigate("BestsellersHousehold", {
        bestSellers,
      });
    } else if (section === "New Arrivals") {
