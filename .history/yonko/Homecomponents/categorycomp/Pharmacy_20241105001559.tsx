              ...
              <View style={styles.variantsContainer}>
                {Array.isArray(item.variants) ? (
                  item.variants.map((variant, vIdx) => (
                    <View key={vIdx} style={styles.variantItem}>
                      <Text style={styles.variantName}>
                        {variant.variantName}:
                      </Text>
                      {variant.variantValues.map(
                        (variantValue, vvIdx) => (
                          <View key={vvIdx} style={styles.variantValueItem}>
                  ...
                  <View style={styles.variantItem}>
                    ...
                    {item.variants.variantValues.map(
                      (variantValue, vvIdx) => (
                        <View key={vvIdx} style={styles.variantValueItem}>
                          <Text style={styles.variantValue}>
                            {variantValue.value}
                          ...
                          {variantValue.options &&
                            variantValue.options.optionValues &&
                            variantValue.options.optionValues.length > 0 && (
                              <View style={styles.optionsContainer}>
                                <Text style={styles.optionName}>
                                  {variantValue.options.optionName}:
                                </Text>
                                {variantValue.options.optionValues.map(
                                  (optionValue, ovIdx) => (
                                    <Text
                                      key={ovIdx}
                                      style={styles.optionValue}
            ...
            {item.specifications && (
              <View style={styles.specificationsContainer}>
                {Object.entries(item.specifications).map(
                  ([key, value], sIdx) => (
                    <View key={sIdx} style={styles.specificationItem}>
