...
import petData from "../../assets/data/petdata.json";
...
const PetSupplies = () => {
  ...
  const [categoryData, setCategoryData] = useState(petData.pet);
  ...
  const handleItemPress = (item, section) => {
    if (section === "Pet Care") {
      navigation.navigate("MainstorePetSupplies", { petSupply: item });
    } else if (section === "Discounts" || section === "New Arrivals") {
      navigation.navigate("PetSuppliesProducts", {
        item,
        petSupplyName: item.petSupplyName,
        petSupplyImageUri: item.petSupplyImageUri,
        petSupplyLocation: item.petSupplyLocation,
      });
    }
  };
  ...
  const handleSectionPress = (section) => {
    if (section === "Pet Care") {
      ...
      navigation.navigate("BestsellersPetSupplies", {
        bestSellers,
      });
    } else if (section === "New Arrivals") {
