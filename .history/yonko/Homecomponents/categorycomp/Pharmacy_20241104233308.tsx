...
function logNestedObject(obj: any, indent = 0) {
  ...
  if (Array.isArray(obj)) {
    ...
    Object.keys(obj).forEach((key) => {
      ...
      logNestedObject(obj[key], indent + 1);
    });
    console.log(`${indentation}}`);
  } else {
    ...
    const fetchData = async () => {
      try {
        ...
        if (data && data.products) {
          ...
          logNestedObject(data.products); // Log the nested data
        } else {
