...
const Tech = () => {
  ...
  const [categoryData, setCategoryData] = useState(techData.tech);
  ...
  const handleItemPress = (item, section) => {
    if (section === "Latest Gadgets") {
      navigation.navigate("MainstoreTech", { tech: item });
  ...
  const handleSectionPress = (section) => {
    if (section === "Latest Gadgets") {
      ...
      navigation.navigate("BestsellersTech", {
        bestSellers,
      });
    } else if (section === "New Arrivals") {
