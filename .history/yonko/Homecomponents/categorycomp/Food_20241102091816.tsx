                ...
                {sortItems(sectionData[section]).map((item, idx) => (
                  ...
                  >
                    <View>
                      ...
                      <View>
                        <Text>{abbreviateName(item.name, 20)}</Text>
                      </View>
                    </View>
                  </TouchableOpacity>
                ))}
                  ...
                  return (
                    ...
                    >
                      <View>
                        ...
                        <View>
                          <Text>{abbreviateName(item.name)}</Text>
                          <Text>{store ? store.name : "Unknown Store"}</Text>
                          <View>
                ...
                {sortItems(sectionData[section]).map((item, idx) => (
                  ...
                  >
                    <View>
                      ...
                      <View>
                        <FontAwesome6 name="clock" size={13} />
