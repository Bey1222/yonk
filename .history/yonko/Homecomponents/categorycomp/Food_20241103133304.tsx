                  ...
                  onPress={() => {
                    if (section === "Popular Near You") {
                      navigation.navigate("PopularNearYouScreen", {
                        popularItems: Object.values(storeData).map((store) => ({
                          ...store,
                          image: store.avatar,
                          name: store.name,
                          rating: store.rating,
                          ...
                          restaurantLocation: store.location,
                          isOpen: isRestaurantOpen(store),
                      ...
                      navigation.navigate("DiscountsScreen", {
                        discountItems: categoryData.map((item) => ({
                          ...item,
                          image: item.images[0],
                          name: item.name,
                          ...
                          restaurantName: item.name,
                          restaurantImageUri: item.images[0],
                          restaurantLocation: item.location,
                      ...
                      navigation.navigate("NewArrivalsScreen", {
                        newItems: categoryData.map((item) => ({
                          ...item,
                          image: item.images[0],
                          name: item.name,
                          discountPrice: item.basePrice,
