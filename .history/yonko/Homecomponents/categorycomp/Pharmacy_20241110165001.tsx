...
const Pharmacy = () => {
  ...
  const navigateToBrandScreen = (brand) => {
    if (brand === "Prescription Drugs") {
      navigation.navigate("PrescriptionDrugsScreen");
    } else if (brand === "First Aid Kits") {
      navigation.navigate("FirstAidKitsScreen");
    } else if (brand === "Protein Shakes") {
      navigation.navigate("ProteinShakesScreen");
    } else if (brand === "Power Bars") {
      navigation.navigate("PowerBarsScreen");
    }
  };
  ...
  const handleNavigation = (item, screenName) => {
    ...
    console.log("Navigating to", screenName, "with pharmacy:", pharmacy);
