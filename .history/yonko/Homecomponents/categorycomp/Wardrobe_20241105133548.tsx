...
const Wardrobe = () => {
  ...
  const handleNavigation = (item, screenName) => {
    ...
    navigation.navigate(screenName, {
      ...
      wardrobeLocation: `${store.address.street}, ${store.address.city}, ${store.address.state}, ${store.address.country}`,
    });
  };
  ...
  const handleNavigationWardrobeProducts = (item, screenName) => {
    ...
    if (screenName === "WardrobeProducts") {
      console.log("Navigating to WardrobeProducts with item:", item);
      navigation.navigate(screenName, {
        item,
        wardrobeName: store.name,
        wardrobeImageUri: store.avatar,
                  ...
                  onPress={() => {
                    if (section === "Trending Fashion") {
                      navigation.navigate("TrendingFashion", {
                        trendingFashion: Object.values(storeData),
                      });
                    } else if (section === "Discounts") {
                ...
                {sectionData[section]?.map((item, idx) => {
                  ...
                  return (
                    <TouchableOpacity
                      ...
                      style={styles.card}
                      onPress={() =>
                        handleNavigationWardrobeProducts(
                          item,
                          "WardrobeProducts"
                        )
                      }
                ...
                {sectionData[section]?.map((store, idx) => {
                  ...
                  return (
                    <TouchableOpacity
                      ...
                      style={styles.sectionItem}
                      onPress={() =>
                        handleNavigation(store, "MainstoreWardrobe")
                      }
                    >
                      <View style={styles.imageContainer}>
                        <Image
